        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, generateInvoice_1.generateInvoice(orderNumber, items, billingAddress, (billingAddress === null || billingAddress === void 0 ? void 0 : billingAddress.isLegalEntity) || false)];
                case 3:
                    invoice = _a.sent();
                ...
                case 5:
                    sanityProducts = products.map(function (item) {
                        ...
                        if (((_a = item.variant) === null || _a === void 0 ? void 0 : _a.curbura) || ((_b = item.variant) === null || _b === void 0 ? void 0 : _b.grosime) || ((_c = item.variant) === null || _c === void 0 ? void 0 : _c.marime)) {
                            return __assign(__assign({}, baseProduct), { variant: {
                        ...
                        else if ((_d = item.variant) === null || _d === void 0 ? void 0 : _d.price) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, Promise.all(products.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                            var product, hasSimpleVariants, variant, variantIndex;
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        hasSimpleVariants = ((_a = product.variants) === null || _a === void 0 ? void 0 : _a.length) > 0 &&
                                            !product.variants[0].curbura &&
                                            !product.variants[0].grosime &&
                                            !product.variants[0].marime;
                                        if (!hasSimpleVariants) return [3 /*break*/, 3];
                                    ...
                                    case 2:
                                        ...
                                        return [3 /*break*/, 7];
                                    case 3:
                                        if (!(product.variants && product.variants.length > 0)) return [3 /*break*/, 5];
