...
var SuccessPage = function () {
    ...
    var _c = react_1.useState(null), orderDetails = _c[0], setOrderDetails = _c[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        if (!(!emailSentRef.current && data)) return [3 /*break*/, 6];
                        return [4 /*yield*/, sendEmail(data)];
                    case 5:
                        _a.sent();
    ...
    var handleDownloadInvoice = function (invoiceNumber) { return __awaiter(void 0, void 0, void 0, function () {
        var response, blob, url_1, a_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("/invoice/" + invoiceNumber + "/download", {
                            headers: {
                ...
                case 2:
                    ...
                    a_1.style.display = 'none'; // Ascundem elementul
                    a_1.href = url_1;
                    a_1.download = "factura_" + invoiceNumber + ".pdf";
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error downloading invoice:', error_1);
    ...
    return (React.createElement("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gray-50" },
        React.createElement("div", { className: "bg-white p-12 rounded-xl shadow-lg max-w-3xl w-full mx-4" },
            ...
            React.createElement("div", { className: "border-t border-b border-gray-200 py-6 mb-6" },
                ...
                ((_a = orderDetails.invoice) === null || _a === void 0 ? void 0 : _a.number) && (React.createElement("button", { onClick: function () { return handleDownloadInvoice(orderDetails.invoice.number); }, className: "text-blue-600 hover:text-blue-800 flex items-center" },
                ...
                React.createElement("div", { className: "space-y-2" },
                    ...
                    orderDetails.awb && (React.createElement("p", { className: "text-gray-600" },
                        React.createElement("strong", null, "AWB:"),
                        " ",
                        orderDetails.awb)),
                    ((_b = orderDetails.billingAddress) === null || _b === void 0 ? void 0 : _b.cui) && (React.createElement(React.Fragment, null,
                        React.createElement("p", { className: "text-gray-600" },
                            React.createElement("strong", null, "CUI:"),
                            " ",
            ...
            React.createElement("div", { className: "mb-6" },
                ...
                React.createElement("ul", { className: "space-y-4" }, orderDetails.products.map(function (product) { return (React.createElement("li", { key: product.product._id, className: "flex justify-between items-center" },
            ...
            React.createElement("div", { className: "border-t border-gray-200 pt-4" },
                ...
                React.createElement("div", { className: "flex justify-between mb-2" },
                    ...
                    React.createElement("span", { className: "text-gray-800 font-medium" },
                        (orderDetails.totalPrice - orderDetails.shippingCost).toFixed(2),
                        " ",
                        orderDetails.currency)),
